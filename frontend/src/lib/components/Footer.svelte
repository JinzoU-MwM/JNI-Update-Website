<footer class="footer">
  <div class="container">
    <div class="footer-grid">
      <div class="footer-brand">
        <a href="/" class="footer-logo">
          <img src="/images/logo-jamnasindoo.png" alt="Jamnasindo" class="footer-logo-img" />
          <span class="footer-brand-text">Jaminan Nasional<br/>Indonesia</span>
        </a>
        <p>Partner terpercaya untuk mengurus segala kebutuhan perizinan dan konsultasi bisnis Anda dengan profesional dan efisien.</p>
        <div class="footer-social">
          <button type="button" aria-label="Facebook" class="social-btn">
          ...
          <button type="button" aria-label="Instagram" class="social-btn">
    ...
    <div class="footer-bottom">
      <p>&copy; {new Date().getFullYear()} Jaminan Nasional Indonesia. All Rights Reserved.</p>
    </div>
  </div>
</footer>
