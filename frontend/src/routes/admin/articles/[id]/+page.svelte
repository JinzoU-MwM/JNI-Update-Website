<script lang="ts">
  ...
  async function loadArticle() {
    ...
    try {
      const response = await fetch(`https://backend-nine-dun-99.vercel.app/api/articles/${articleId}`);
...
<div class="article-editor">
  ...
  {:else if error && !form.title}
    <div class="error-state">
      ...
      <p>{error}</p>
      <a href="/admin/articles" class="btn btn-primary">Back to Articles</a>
    </div>
  {:else}
    <div class="editor-header">
      <div class="header-content">
        ...
        <h1>Edit Article</h1>
        <p>Update the article content and settings</p>
      </div>
    </div>
      ...
      <div class="form-sidebar">
        <div class="sidebar-card">
          ...
          <div class="publish-options">
            ...
            <p class="option-hint">Toggle to change publication status</p>
          </div>
